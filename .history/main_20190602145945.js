...
var portfolioImages = $(".portfolio-box a img");

$.each(portfolioImages, function(e){
    console.log(this);
    var overlay;
    $(this).hover(function enterPic(i) {
        overlay = "<div class='portfolio-hover'><img src='http://s3.amazonaws.com/architecture-org/files/events/sqr_lrg_millenium-park-cloud-gate-03.jpg' alt='A clothes rack'></div>";
        $(this).wrap(overlay);
    }, function exitPic(i) {
        $(this).unwrap();
    });
