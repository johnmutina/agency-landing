...
$(".form-submit").click(function(e){
    if (
        ($("input[name=name]").text() !== "" && $(".name-error").text() === "") &&
        ($("input[name=email]").text() !== "" && $(".email-error").text() === "") && 
        ($("input[name=phone]").text() !== "" && $(".phone-error").text() === "") && 
        ($("textarea[name=message]").text() !== "" && $(".message-error").text() === "") &&
        console.log("YES!")
    }
