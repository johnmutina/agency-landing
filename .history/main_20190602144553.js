...
$.each(portfolioImages, function(e){
    console.log(this);
    $(this).hover(function enterPic(e) {
            // over
    ...
    // portfolioImages[e].addClass("portfolio-hover");
    // e.hover(function enterPic(){
        // $(".portfolio-box a").addClass("portfolio-hover");
    // }, function exitPic(e){
    //     console.log("Out!")
    //     $(".portfolio-box a img").removeClass("portfolio-hover");
    // })
});
